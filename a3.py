...
class DirectMessengerGUI:
    ...
    def _setup_ui(self):
        ...
        self.contacts_tree = ttk.Treeview(
            left_panel, height=20, selectmode='browse', show='tree')
        ...
        self.login_frame = ttk.LabelFrame(
            right_panel, text="Login", padding="10")
        ...
        if self.connected and self.messenger:
            try:
                ...
                for msg in new_messages:
                    ...
                    if not any(m.timestamp == msg.timestamp and m.message ==
                               msg.message for m in self.messages[sender]):
    ...
    def _load_messages(self):
        ...
        try:
            ...
            for msg in all_messages:
                ...
                if not any(m.timestamp == msg.timestamp and m.message ==
                           msg.message for m in self.messages[contact]):
